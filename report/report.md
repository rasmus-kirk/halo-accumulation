...
\centering
  \begin{subfigure}[b]{0.45\textwidth}
    ...
    \addplot[color=GbRedDk, mark=square*] plot coordinates {
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    ...
    \addplot[color=GbRedDk, mark=square*] coordinates {(512, 6.0183) (1024, 6.5114) (2048, 7.7752) (4096, 9.7851) (8196, 10.899) (16384, 15.176)};
    \legend{acc\_cmp\_s, acc\_cmp\_f}
    \end{axis}
    \end{tikzpicture}
  \end{subfigure}
